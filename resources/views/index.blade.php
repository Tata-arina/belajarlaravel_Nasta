    ...
    <section id="header" class="header">
        <div class="container">
            <h1 class="judul-header">
                <p class="text-secondary-emphasis fw-bold">Selamat Datang Di <br> Blog Nasta
            </h1>
        </div>
    </section>
        ...
        <div class="container">
            ...
            @foreach ($posts as $post)
                <div class="card mb-3 mt-3" style="max-width: 100%;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{ asset('storage/' . $post->gambar_post) }}" class="img-fluid rounded-start"
                                alt="...">
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text"><small class="text-body-secondary">{{ $post->users['name'] }} </small>
                                    <a href="" class="btn"><i class="bi bi-heart"></i> like</a> <a href=""
                                        class="btn"><i class="bi bi-chat-text"></i>Comment</a>
                                </p>
                            </div>
                        </div>
                    </div>
